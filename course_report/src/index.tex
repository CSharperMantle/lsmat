...
\begin{tikzpicture}[shorten >=1pt,node distance=3cm,on grid,auto]
    \node[state, initial] (q_0) {\includegraphics[scale=0.2]{u2757}};
    \node[state] (q_1) [above right=of q_0] {\includegraphics[scale=0.2]{u2753}};
    \node[state] (q_2) [below right=of q_1] {\includegraphics[scale=0.2]{u1f44d}};
  
    \path[->] (q_0) edge node {\includegraphics[scale=0.2]{u1f914}} (q_1)
              (q_1) edge node {\includegraphics[scale=0.2]{u1f4a1}} (q_2)
                    edge [loop above] node {\includegraphics[scale=0.2]{u1f50d}} ()
              (q_2) edge node {\includegraphics[scale=0.2]{u1f9d1_200d_1f4bb}} (q_0);
\end{tikzpicture}
